...
namespace TechXpress.Infrastructure.Migrations
{
    ...
    [Migration("20250601115701_UpdatedOrderItemsConfig")]
    partial class UpdatedOrderItemsConfig
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TechXpress.Domain.Models.Address", b =>
                {
                    b.HasOne("TechXpress.Domain.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
                        .HasForeignKey("ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TechXpress.Domain.Models.Customer", null)
                        .WithMany("Addresses")
            ...
            modelBuilder.Entity("TechXpress.Domain.Models.Order_Item", b =>
                {
                    b.HasOne("TechXpress.Domain.Models.Orders", "Order")
